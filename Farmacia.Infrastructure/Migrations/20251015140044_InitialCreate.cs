        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ingresos = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Egresos = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Diferencia = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArqueosCaja_Cajas_CajaId",
                        column: x => x.CajaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroAutorizacion = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BajasProducto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BajasProducto_Productos_ProductoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    NumeroLote = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Traspasos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Traspasos_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArqueosCaja_CajaId",
                table: "ArqueosCaja",
                column: "CajaId");

            migrationBuilder.CreateIndex(
                name: "IX_BajasProducto_ProductoId",
                table: "BajasProducto",
                column: "ProductoId");
